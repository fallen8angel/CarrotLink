...
internal object NativeDriveArLayoutProfileTuning {
    private val roadAttached =
        NativeDriveArLayoutProfileSpec(
            ...
            cardCompactWidthFraction = 0.24f,
            cardRegularWidthFraction = 0.28f,
            cardMetaHeightFraction = 0.11f,
            cardBodyHeightFraction = 0.095f,
            statusHorizontalPaddingCompact = 18f,
            statusHorizontalPaddingRegular = 22f,
            gateCompactHeight = 38f,
            gateRegularHeight = 44f,
            gateCompactTextSize = 12.5f,
            gateRegularTextSize = 14.0f,
        )
